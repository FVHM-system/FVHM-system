<template>
    <div class="p-page">
        ...
        <div class="p-body">
            <el-table :data="areaList" style="width: 100%" size="medium" stripe>
...
<script setup>
 ...
 import {fetchCityList,fetchAreaList,AddAreaInfoByConfig,editAreaInfoByConfig,deleteAreaInfoById} from '../../apis/2.0/addr'
 let areaList=ref([])
 let cityList=ref([])
 let modal = ref()
