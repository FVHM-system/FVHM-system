  ...
  <div class="p-page">
    ...
    <div class="p-body" id="box">
      <el-table
          ...
          :data="districtList" style="margin-top:10px;width: 100%" size="medium" :sort-method="sortDevName" :height="tableHeight" empty-text=" " stripe>
        <el-table-column prop="district" sortable label="区县名" min-width="150"></el-table-column>
