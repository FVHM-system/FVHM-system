<template>
    <div class="p-page">
        ...
        <div class="p-body">
          ...
          color:'#219DEDF2',fontWeight:500,'text-align':'center'}"
                ...
                :data="districtList" style="margin-top10px;width: 100%" size="medium" stripe>
    ...
    <el-dialog v-model="modalState" :title="modalTitle"  center>
        ...
        <el-form-item label="所属城市" required>
            ...
            <el-option v-for="item in cityList" :key="item.zoneId" :label="item.city" :value="item.zoneId"></el-option>
            </el-select>
        </el-form-item>
        </el-form>
        <template #footer>
...
<script setup>
 ...
 import {fetchCityList,fetchDistrictList,AddDistrictInfoByConfig,editDistrictInfoByConfig,deleteDistrictInfoById} from '../../apis/2.0/addr'
