    ...
    <div class="p-body" id="box">
      <el-table :data="villageList"
          ...
          color:'#219DEDF2',fontWeight:500,'text-align':'center'}"
                ...
                size="medium" :height="tableHeight" empty-text=" " :sort-method="sortDevName" stripe>
...
const valveNameCheck = (rule, value, callback) => {
  ...
  }else if(villageNameList.find(i=>i.value===value)){
    return callback(new Error('村庄名称重复！'))
  }
  else {
    callback()
  }
...
const myFunc = {
  async search() {
    ...
    villageNameList = temp1.map(item=>{
      return{
        value:item.village
      }
    })
