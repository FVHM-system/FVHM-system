<template>
    <div class="p-page">
        ...
        <div class="p-body">
            <el-table :data="villageList" style="width: 100%" size="medium" stripe>
    ...
    <el-dialog v-model="modalState" :title="modalTitle"  center>
        ...
        <el-form-item label="所属乡镇" required>
            ...
            <el-option v-for="item in townList" :key="item.zoneId" :label="item.town" :value="item.zoneId"></el-option>
            </el-select>
        </el-form-item>
        </el-form>
        <template #footer>
...
<script setup>
 ...
 import {fetchCityList,fetchDistrictList,fetchTownList,fetchVillageList,AddVillageInfoByConfig,editVillageInfoByConfig,deleteVillageInfoById} from '../../apis/2.0/addr'
 let villageList=ref([])
 let townList=ref([])
