<template>
    ...
    <el-dialog v-model="modalState" :title="modalTitle"  center>
        ...
        <el-form-item label="所属区县" required>
            ...
            <el-option v-for="item in districtList" :key="item.zoneId" :label="item.district" :value="item.zoneId"></el-option>
            </el-select>
        </el-form-item>
        </el-form>
        <template #footer>
...
<script setup>
 ...
 import {fetchCityList,fetchDistrictList,fetchTownList,AddTownInfoByConfig,editTownInfoByConfig,deleteTownInfoById} from '../../apis/2.0/addr'
 let townList=ref([])
