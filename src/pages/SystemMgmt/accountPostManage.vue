  ...
  <div class="p-page">
    <div class="p-header">
      <div class="p-name">
        ...
        <div class="button">
          <el-button icon="el-icon-plus" @click="postFunc.selectAll" style="margin-left: -230px">全选</el-button>
        ...
        <el-table-column fixed="right" label="选择用户" width="400">
          <template #default="scope">
            <el-button
              ...
              >已选择</el-button
            >
            <el-button v-if="scope.row.roleId != id" icon="el-icon-plus" @click="postFunc.selectRow(scope.row)"
              >未选择</el-button
            >
          </template>
        </el-table-column>
