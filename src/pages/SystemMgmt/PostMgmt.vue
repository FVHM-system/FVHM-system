...
<div class="p-page">
  ...
  <div class="p-header">
    ...
    <el-button class="addbutton" type="primary" @click="() => addModal.changeState(true)">新增岗位</el-button>
  </div>
      ...
      <el-table
        ...
        <el-table-column label="操作" width="650" fixed="right">
          <template #default="scope">
            ...
            <el-button @click="editModal.changeState(true) || changeCurrent(scope.row)">修改信息</el-button>
            <el-popconfirm
