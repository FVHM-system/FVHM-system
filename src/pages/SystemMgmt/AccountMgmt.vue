      ...
      <el-table
        ...
        <el-table-column width="700px" label="操作" fixed="right">
          <template #default="scope">
            ...
            >修改岗位</el-button
          > -->
            <el-button type="primary" @click="changeModal.editDesc(true) && changeCurrentUser(scope.row)">修改备注</el-button>
            <el-button type="primary" @click="changeModal.editPassword(true) && changeCurrentUser(scope.row)">修改密码</el-button>
            <el-popconfirm
